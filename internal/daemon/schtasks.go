...
// windowsQuoteArg applies the standard Windows command-line argv quoting
// (backslash doubling before quotes). It is intentionally complete rather
// than a simple space-check: BinaryPath and config paths are user-supplied
// and may contain spaces, trailing backslashes, or quotes, all of which the
// full state machine handles correctly.
