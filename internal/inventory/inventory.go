...
type RootCandidate struct {
	...
	// Unconsumed marks a root the owning tool's CLI does not read (e.g.
	// codex's ~/.codex/skills): SkillFleet manages it but the tool ignores
	// it. Advisory; the WebUI warns the operator before adopting it.
	Unconsumed bool `json:"unconsumed,omitempty"`
}
