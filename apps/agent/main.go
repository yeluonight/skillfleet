...
func printUsage(w *os.File) {
	...
	_, _ = fmt.Fprintln(w, "  skillfleet-agent start                              # install + start systemd user service")
	_, _ = fmt.Fprintln(w, "  skillfleet-agent stop                               # stop the systemd user service")
	_, _ = fmt.Fprintln(w, "  skillfleet-agent restart                            # restart the systemd user service")
